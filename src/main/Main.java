...
//        Task task2 = new Task("Обед", "Приготовить обед");
        Epic epic1 = new Epic("Написать код проекта", "Написать 2 проекта", 3, StatusCodes.NEW);
        SubTask subTask1 = new SubTask("Написать проект спринта 4", "Написать проект спринта 4", 24, StatusCodes.NEW, 3, Duration.of(4, ChronoUnit.HOURS), LocalDateTime.of(2024, 12, 20, 22, 0, 0));
...
//        System.out.println(taskManager.getEpicsList());
//        System.out.println(taskManager.getSubTasksList());
        Task task45 = new Task("Заffdвтрак", "Приготовить завтракfrr", 233, StatusCodes.DONE, Duration.of(4, ChronoUnit.HOURS), LocalDateTime.of(2024, 12, 21, 15, 0, 0));
